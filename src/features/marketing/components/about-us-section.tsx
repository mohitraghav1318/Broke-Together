      ...
      <div className="mx-auto grid w-full max-w-6xl gap-8 lg:grid-cols-[1fr_420px] lg:items-center">
        ...
        <div className="glow-card marketing-reveal rounded-lg border border-emerald-100 bg-white p-6 shadow-sm">
          <div className="grid gap-4">
            {[
              ["Clear by default", "Balances, categories, and reports stay visible."],
              ["Shareable by design", "Friends can join the same notebook link."],
              ["Simple to maintain", "Edit people and categories as the group changes."],
            ].map(([title, body]) => (
              <div
